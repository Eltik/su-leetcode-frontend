...
import middleware from "./impl/middleware";
import routes from "./impl/routes";
...
const start = async () => {
    ...
    Bun.serve({
        ...
        async fetch(req: Request) {
            ...
            if (url.pathname === "/") return middleware.createResponse("Welcome to Myrtle API! 🎉", 200, { "Content-Type": "text/plain" });
